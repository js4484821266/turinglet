...
정리되지 않은 말도 편하게 받아 주고 가볍게 곁에 머무는 AI 말동무를 목표로, 답변 내용보다 대화 타이밍 제어를 실험하는 이벤트 기반 AI 대화 프로토타입
...
삼마고는 상담 서비스가 아니라, 사용자가 정리되지 않은 말이나 기분도 편하게 털어놓을 수 있는 AI 말동무 프로토타입입니다.
일반적인 챗봇처럼 질문이 오면 바로 답하는 구조를 그대로 따르지 않습니다.
이 프로젝트의 중심은 사용자의 말을 평가하거나 해결책으로 몰아가기보다, 대화 흐름을 어떻게 부담 낮게 운영할지에 있습니다.

다루는 질문은 다음과 같습니다.

- 지금 바로 답하는 게 맞는가?
- 잠깐 기다리는 게 더 자연스러운가?
- 말동무처럼 먼저 짧게 말을 거는 게 자연스러운가?
- 반응 메시지는 한 번에 몇 개를 보내는 게 적절한가?

즉, "무엇을 말할지"와 "언제 말할지"를 분리해 다루는 말동무형 대화 프로토타입입니다.
...
- 삼마고는 말동무 프로토타입이며, 상담·의료·응급 서비스를 대체하지 않습니다.
- 위기 대응 체계는 연구용 프로토타입 수준이며, 실제 서비스 수준과는 거리가 있습니다.
