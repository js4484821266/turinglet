...
산마고우(Sammagou)는 어릴 때부터 함께 자란 가까운 친구를 뜻하는 `죽마고우(竹馬故友)`에서 가져온 이름입니다. 사용자의 곁에서 대화의 맥락을 기억하고, 필요할 때 먼저 말을 건네는 오래된 친구 같은 AI를 지향한다는 의미를 담았습니다.

## 프로젝트 소개

산마고우는 일반적인 챗봇처럼 질문이 오면 바로 답하는 구조를 그대로 따르지 않습니다.
