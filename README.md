...
삼마고(Saammago)는 다음과 같은 연상 과정에서 나온 이름입니다.

`사람처럼 메시지를 보내는 AI → 내가 무슨 말을 해도 받아주는 존재 → 대나무숲 → 竹(대나무 죽) → 죽마고우 → '죽다'의 반의어인 '살다' → 산마고우 → 음소 동화 → 삼마고`

무슨 이야기든 받아주는 대나무숲이면서, 죽마고우처럼 오래 곁에 머물고, 살아 있는 상대처럼 먼저 말을 건네는 AI 컴패니언이라는 의미를 담았습니다.
