...
산마고우(Saammagou)의 이름은 `컴패니언 → 대나무숲 → 죽마고우(竹馬故友) → 살아 있는 존재`라는 생각의 흐름에서 나왔습니다. 편하게 속마음을 털어놓을 수 있는 대나무숲이면서, 오랫동안 곁을 지킨 죽마고우처럼 맥락을 기억하고 먼저 말을 건네며, 단순한 도구를 넘어 살아 있는 듯 함께하는 AI 컴패니언을 지향합니다.
