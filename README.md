...
![초기 화면](screenshots/44444%20initial.png)

- QR 기반 가입/로그인 화면과 기본 진입 구성을 확인할 수 있습니다.

### 2. ID 생성 및 QR 발급

![ID 생성 및 QR 발급](screenshots/66666%20created%20id.png)

- 가입 시 긴 랜덤 ID와 QR 발급 흐름을 보여줍니다.

### 3. 채팅 시작 화면

![채팅 초기 상태](screenshots/77777%20chat%20initial.png)

- 메신저 UI, 상태 표시, 입력창 구성을 확인할 수 있습니다.

### 4. 비동기 대화 반응 예시

![비동기 반응 예시 1](screenshots/88888%20async%20chat%20malfunc1.png)

![비동기 반응 예시 2](screenshots/94444%20async%20chat%20malfunc2.png)

- 메시지 타이밍/분할 전송/대기 흐름을 점검하는 캡처입니다.
